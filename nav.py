...
if selected == "Home":
    ...
    with st.container():
        st.subheader('Tips for investment:')
        st.write('1. Set personal financial goals that are attainable, realistic, attainable and time bound.')
        st.write('2. Make investment a habit by getting up a regular investment plan.')
        st.write('3. Keep an eye on your spending and avoid unnecessary debts.')
        st.write('4. Before you make any financial decision, research, before you invest, investigate.')
        st.write('5. Agree on your family goals, risk appetite and choose a suitable investment.')
        st.write('6. Try to hold your investment as long as possible to enjoy significant growth.') 
...
#         repurchase_price_per_unit_jikimu = st.number_input('Repurchase Price per Unit', min_value=0.0)
        ...
        if st.button("Forecast"):
            ...
            X_jikimu = jikimu_data[['Log_ONU', 'Year', 'Month', 'Day']]
            ...
            # Calculate and display the predicted NAV value for Jikimu Fund
            predicted_sqrt_nav_jikimu = ensemble_model_jikimu.predict([[log_onu_jikimu, year_jikimu, month_jikimu, day_jikimu]])[0]
        ...
        if st.button("Forecast"):
            ...
            X_watoto = watoto_data[['Log_ONU', 'Year', 'Month', 'Day']]
...
#                 joblib.dump(ensemble_model_watoto, model_file)
            ...
            # Calculate and display the predicted NAV value for Watoto Fund
            predicted_sqrt_nav_watoto = ensemble_model_watoto.predict([[log_onu_watoto, year_watoto, month_watoto, day_watoto]])[0]
        ...
        if st.button("Forecast"):
            ...
            X_liquid = liquid_data[['Log_ONU', 'Year', 'Month', 'Day']]
            ...
            # Calculate and display the predicted NAV value for Liquid Fund
            predicted_sqrt_nav_liquid = ensemble_model_liquid.predict([[log_onu_liquid, year_liquid, month_liquid, day_liquid]])[0]
        ...
        if st.button("Forecast"):
            ...
            X_umoja = umoja_data[['Log_ONU', 'Year', 'Month', 'Day']]
...
#                 joblib.dump(ensemble_model_umoja, model_file)
            ...
            # Calculate and display the predicted NAV value for Umoja Fund
            predicted_sqrt_nav_umoja = ensemble_model_umoja.predict([[log_onu_umoja, year_umoja, day_umoja, month_umoja]])[0]
        ...
        if st.button("Forecast"):
            ...
            X_wekeza_maisha = wekeza_maisha_data[['Log_ONU', 'Year', 'Month', 'Day']]
            ...
            # Calculate and display the predicted NAV value for Wekeza Maisha Fund
            predicted_sqrt_nav_wekeza_maisha = ensemble_model_wekeza_maisha.predict([[log_onu_wekeza_maisha, year_wekeza_maisha, month_wekeza_maisha, day_wekeza_maisha]])[0]
